...
abstract class BaseCompaniesPeer {
	...
	const EMPLOYEE_ID = 'companies.EMPLOYEE_ID';

	/** the column name for the EMPLOYEE_NAME field */
	const EMPLOYEE_NAME = 'companies.EMPLOYEE_NAME';

	/** the column name for the EMPLOYEE_SURNAME field */
	const EMPLOYEE_SURNAME = 'companies.EMPLOYEE_SURNAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('EmployeeId', 'EmployeeName', 'EmployeeSurname', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('employeeId', 'employeeName', 'employeeSurname', ),
		BasePeer::TYPE_COLNAME => array (self::EMPLOYEE_ID, self::EMPLOYEE_NAME, self::EMPLOYEE_SURNAME, ),
		BasePeer::TYPE_FIELDNAME => array ('employee_id', 'employee_name', 'employee_surname', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('EmployeeId' => 0, 'EmployeeName' => 1, 'EmployeeSurname' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('employeeId' => 0, 'employeeName' => 1, 'employeeSurname' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::EMPLOYEE_ID => 0, self::EMPLOYEE_NAME => 1, self::EMPLOYEE_SURNAME => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('employee_id' => 0, 'employee_name' => 1, 'employee_surname' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(CompaniesPeer::EMPLOYEE_ID);
		$criteria->addSelectColumn(CompaniesPeer::EMPLOYEE_NAME);
		$criteria->addSelectColumn(CompaniesPeer::EMPLOYEE_SURNAME);
	}
    ...
    foreach (sfMixer::getCallables('BaseCompaniesPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCompaniesPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(CompaniesPeer::EMPLOYEE_ID) && $criteria->keyContainsValue(CompaniesPeer::EMPLOYEE_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CompaniesPeer::EMPLOYEE_ID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseCompaniesPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCompaniesPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CompaniesPeer::EMPLOYEE_ID);
			$selectCriteria->add(CompaniesPeer::EMPLOYEE_ID, $criteria->remove(CompaniesPeer::EMPLOYEE_ID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CompaniesPeer::EMPLOYEE_ID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CompaniesPeer::EMPLOYEE_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CompaniesPeer::DATABASE_NAME);
			$criteria->add(CompaniesPeer::EMPLOYEE_ID, $pks, Criteria::IN);
